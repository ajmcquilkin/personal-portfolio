export type ProjectTags = 'Entrepreneurship' | 'Engineering' | 'Web Development' | 'Embedded Development' | 'Mentorship' | 'Dev Ops';
export const ProjectTagsArray: ProjectTags[] = ['Entrepreneurship', 'Engineering', 'Web Development', 'Embedded Development', 'Mentorship', 'Dev Ops'];
