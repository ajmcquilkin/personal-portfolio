...
export const HomeSkillsCardContent: HomeInformationCardEntry[] = [
    ...
    },
    {
        ...
        addlLines: [
            {
                label: 'Programs',
                content: 'Figma, Zeplin, Adobe Photoshop, Adobe Illustrator, Adobe CC'
            }
        ]
    },
    {
        ...
        addlLines: [
            {
                label: 'Languages',
                content: 'C / C++, Bash, Verilog, Python'
            },
            {
                label: 'Frameworks',
                content: 'Arduino, PlatformIO, Xilinx ISE, Circuit Python, Fusion 360'
            }
        ]
    },
];
