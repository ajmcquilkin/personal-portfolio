...
export const HomeExperienceCardContent: HomeInformationCardEntry[] = [
  {
    title: "Microsoft",
    subtitle: "Software Engineer Intern, Power BI Reach Team",
    rightText: "June 2022 - Sept 2022",
    description:
...
export const HomeAchievementsCardContent: HomeInformationCardEntry[] = [
  {
...
export const HomeSkillsCardContent: HomeInformationCardEntry[] = [
  {
    ...
    subtitle: "Specialzing in dataflow management and Jamstack applications",
    description:
    ...
    addlLines: [
      {
        label: "Languages",
        content: "Typescript, Javascript, HTML, CSS, SASS / SCSS",
      },
      {
        label: "Frameworks",
        content: "Git, ReactJS, Redux, NextJS, Webpack, Babel",
      },
    ],
  },
  {
    title: "Backend Web Development",
    subtitle: "Specializing in robust and efficient service development",
    description:
    ...
    addlLines: [
      {
        label: "Languages",
        content: "Typescript, Javascript, C#, Python, Java, C++, Ruby",
      },
      {
        label: "Frameworks",
        content: "NodeJS, ExpressJS, ASP.NET, Ruby on Rails, Deno",
      },
    ],
  },
  {
    title: "Embedded Development",
    subtitle: "Experienced in IoT and web-enabled device development",
    description:
    ...
    addlLines: [
      {
        label: "Languages",
        content: "C / C++, SystemVerilog, VHDL, Verilog, Python",
      },
      {
        label: "Frameworks",
        content: "Xilinx Vivado / ISE, Visual Studio, Arduino, Fusion 360",
      },
    ],
  },
  {
    title: "Product Design",
    subtitle: "Experienced in creating coherent user experiences",
    description:
    ...
    addlLines: [
      {
        label: "Programs",
        content: "Figma, Adobe Photoshop, Adobe Illustrator, Adobe CC",
      },
    ],
  },
];
